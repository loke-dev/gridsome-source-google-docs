...
const convertJsonToMarkdownDocument = require('./convert-json-to-markdown-document')
    ...
    async file =>
      new Promise(async (resolve, reject) => {
        try {
          ...
          const markdown = convertJsonToMarkdownDocument({ file, content })
          const body = convertJsonToMarkdown({ file, content })
